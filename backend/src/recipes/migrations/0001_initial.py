# Generated by Django 3.2 on 2023-03-24 19:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredients', models.ManyToManyField(related_name='recipes', through='recipes.IngredientAmount', to='recipes.Ingredient', verbose_name='Ингридиенты рецепта')),
            ],
            options={
                'verbose_name': 'Рецепт',
